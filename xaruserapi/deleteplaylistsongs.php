 ...
 */
function mp3jukebox_userapi_deleteplaylistsongs($args)
{
    ...
    if (!isset($playlistid) || !is_numeric($playlistid)) {
        $msg = xarML('Invalid #(1) for #(2) function #(3)() in module #(4)',
            'playlist ID', 'user', 'deleteplaylistsongs', 'MP3Jukebox');
     ...
     */
    $query = "DELETE FROM $mp3jukebox_playlist_songs_table WHERE xar_playlistid = ?";

 ...
 *
 * - http://mysite.com/index.php/maxercalls/ (main function)
 * - http://mysite.com/index.php/maxercalls/list.html (view function)
 * - http://mysite.com/index.php/maxercalls/123.html (display function)
 *
 * in addition to the 'normal' Xaraya URLs that look like :
 *
 * - http://mysite.com/index.php?module=maxercalls&func=display&exid=123
 *
 * You can also combine the two, e.g. for less frequently-used parameters :
 *
 * - http://mysite.com/index.php/maxercalls/list.html?startnum=21
 *
 *
 ...
 * except that by default, the URLs will start with index.php/admin/maxercalls.
 ...
 */
function maxercalls_userapi_encode_shorturl($args)
{
    ...
    if ($func == 'main') {
        ...
        // create different virtual paths here - for maxercalls a category name
        ...
        // regular URL parameters - maxercalls for an array :
        ...
        if (isset($callid) && is_numeric($callid)) {
            $path = '/' . $module . '/' . $callid . '.html';
            // you might have some additional parameter that you want to use to
            // create different virtual paths here - for maxercalls a category name
            // See above for an maxercalls...
        } else {

 ...
 *
 * - http://mysite.com/index.php/sigmapersonnel/ (main function)
 * - http://mysite.com/index.php/sigmapersonnel/list.html (view function)
 * - http://mysite.com/index.php/sigmapersonnel/123.html (display function)
 *
 * in addition to the 'normal' Xaraya URLs that look like :
 *
 * - http://mysite.com/index.php?module=sigmapersonnel&func=display&exid=123
 *
 * You can also combine the two, e.g. for less frequently-used parameters :
 *
 * - http://mysite.com/index.php/sigmapersonnel/list.html?startnum=21
 *
 *
 ...
 * except that by default, the URLs will start with index.php/admin/sigmapersonnel.
 ...
 * @todo Everything
 */
function sigmapersonnel_userapi_encode_shorturl($args)
{
    ...
    if ($func == 'main') {
        ...
        // create different virtual paths here - for sigmapersonnel a category name
        ...
        // regular URL parameters - sigmapersonnel for an array :
        ...
        if (isset($exid) && is_numeric($exid)) {
            ...
            // you might have some additional parameter that you want to use to
            // create different virtual paths here - for sigmapersonnel a category name
            // See above for an sigmapersonnel...
        } else {

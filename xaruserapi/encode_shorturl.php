 ...
 *
 * - http://mysite.com/index.php/phplot/ (main function)
 * - http://mysite.com/index.php/phplot/list (view function)
 * - http://mysite.com/index.php/phplot/123 (display function)
 *
 * in addition to the 'normal' Xaraya URLs that look like:
 *
 * - http://mysite.com/index.php?module=phplot&func=display&exid=123
 *
 * You can also combine the two, e.g. for less frequently-used parameters:
 *
 * - http://mysite.com/index.php/phplot/list?startnum=21
 *
 *
 ...
 * except that by default, the URLs will start with index.php/admin/phplot.
 ...
 */
function phplot_userapi_encode_shorturl($args)
{
    ...
    if ($func == 'main') {
        ...
        if (isset($exid) && is_numeric($exid)) {
            ...
            // create different virtual paths here - for phplot a category name
            // See above for an phplot...
        } else {

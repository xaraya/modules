 ...
 */
function dossier_userapi_encode_shorturl($args)
{
    ...
    $aliasisset = xarModGetVar('dossier', 'useModuleAlias');
    $aliasname = xarModGetVar('dossier','aliasname');
    ...
    $module = $usealias ? $aliasname : 'dossier';

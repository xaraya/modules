 ...
 *
 * - http://mysite.com/index.php/mp3jukebox/ (main function)
 * - http://mysite.com/index.php/mp3jukebox/list (view function)
 * - http://mysite.com/index.php/mp3jukebox/123 (display function)
 *
 * in addition to the 'normal' Xaraya URLs that look like:
 *
 * - http://mysite.com/index.php?module=mp3jukebox&func=display&exid=123
 *
 * You can also combine the two, e.g. for less frequently-used parameters:
 *
 * - http://mysite.com/index.php/mp3jukebox/list?startnum=21
 *
 *
 ...
 * except that by default, the URLs will start with index.php/admin/mp3jukebox.
 ...
 */
function mp3jukebox_userapi_encode_shorturl($args)
{
    ...
    if ($func == 'main') {
        ...
        if (isset($exid) && is_numeric($exid)) {
            ...
            // create different virtual paths here - for mp3jukebox a category name
            // See above for an mp3jukebox...
        } else {

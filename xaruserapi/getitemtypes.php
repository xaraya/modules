...
function otp_userapi_getitemtypes($args)
{
    ...
    $itemtypes[1] = ['label' => xarML('Native Otp'),
                          'title' => xarML('View Otp'),
                          'url'   => xarController::URL('otp', 'user', 'view'),
                         ];

    $extensionitemtypes = xarMod::apiFunc('dynamicdata', 'user', 'getmoduleitemtypes', ['moduleid' => 30053, 'native' => false]);

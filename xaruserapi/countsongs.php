<?php
/**
 * Utility function to count the number of songs held by this module
 *
 * @package modules
 ...
 * @return integer number of songs held by this module
 * @throws DATABASE_ERROR
 */
function mp3jukebox_userapi_countsongs()
{
    /* Get database setup - note that both xarDBGetConn() and xarDBGetTables()
     * return arrays but we handle them differently. For xarDBGetConn() we
     * currently just want the first song, which is the official database
    ...
    /* Get song - the formatting here is not mandatory, but it does make the
     ...
     */
    if (!$result) return;
    /* Obtain the number of songss */
    list($numsongs) = $result->fields;

...
function commerce_userapi_db_install($database, $sql_file) {
    global $db_error;

    $db_error = false;

    if (!@xtc_db_select_db($database)) {
      if (@new xenQuery_installer('create database ' . $database)) {

...
function crispbb_userapi_getposts($args)
{
    ...
    for (; !$result->EOF; $result->MoveNext()) {
        ...
        if (empty($nolinks)) { // skip links (when called by shorturl encode this is necessary)
            // topic readers
            $post['viewtopicurl'] = xarModURL(
                'crispbb',
                'user',
                'display',
                array('tid' => $post['tid'])
            );
            $post['viewreplyurl'] = xarModURL(
                'crispbb',
                'user',
                'display',
                array('tid' => $post['tid'], 'pid' => $post['pid'])
            );
            $post['displayreplyurl'] = xarModURL(
                'crispbb',
                'user',
                'displayreply',
                array('pid' => $post['pid'])
            ...
            if ($loggedin) {
                ...
                if ($post['pid'] == $post['firstpid']) {
                    ...
                    if (xarMod::apiFunc(
                        ...
                        if ($post['tstatus'] == 2) {
                            $post['approvetopicurl'] = xarModURL(
                                'crispbb',
                                'user',
                                'moderate',
                                array(
                    ...
                    if (xarMod::apiFunc(
                        ...
                        if ($post['tstatus'] == 5) {
                            $post['undeletetopicurl'] = xarModURL(
                                'crispbb',
                                'user',
                                'moderate',
                                array(
                    ...
                    if (xarMod::apiFunc(
                        ...
                        $post['modforumurl'] = xarModURL(
                            'crispbb',
                            'user',
                            'moderate',
                            array('component' => 'topics', 'fid' => $post['fid'])
                        );
                        $post['modtopicurl'] = xarModURL(
                            'crispbb',
                            'user',
                            'moderate',
                    ...
                    if (xarMod::apiFunc(
                        ...
                        $post['approvereplyurl'] = xarModURL(
                            'crispbb',
                            'user',
                            'moderate',
                            array(
                    ...
                    if (xarMod::apiFunc(
                        ...
                        if ($post['pstatus'] == 5) {
                            $post['undeletereplyurl'] = xarModURL(
                                'crispbb',
                                'user',
                                'moderate',
                                array(

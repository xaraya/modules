 ...
 */
function mp3jukebox_userapi_decode_shorturl($params)
{
    /* Initialise the argument list we will return */
    $args = array();
    $module = 'mp3jukebox';
    /* Check and see if we have a module alias */
    $aliasisset = xarModGetVar('mp3jukebox', 'useModuleAlias');
     ...
     * $params[1] contains the first part after index.php/mp3jukebox
    ...
    if (empty($params[1])) {
         ...
         * $cid = xarModGetVar('mp3jukebox','mastercids');

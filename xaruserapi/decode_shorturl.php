 ...
 */
function phplot_userapi_decode_shorturl($params)
{
    /* Initialise the argument list we will return */
    $args = array();
    $module = 'phplot';
    /* Check and see if we have a module alias */
    $aliasisset = xarModGetVar('phplot', 'useModuleAlias');
     ...
     * $params[1] contains the first part after index.php/phplot
    ...
    if (empty($params[1])) {
         ...
         * $cid = xarModGetVar('phplot','mastercids');

<?php
/* -----------------------------------------------------------------------------------------
   $Id: configuration.php,v 1.2 2003/12/31 10:54:08 fanta2k Exp $   
...
define('EMAIL_SUPPORT_ADDRESS_DESC' , 'Please enter a correct email adress for sending emails over the <b>Support System</b> (account creation, password changes).');
...
define('EMAIL_SUPPORT_REPLY_ADDRESS_DESC' , 'Please enter a email adress for replies of your customers.');
define('EMAIL_SUPPORT_REPLY_ADDRESS_NAME_TITLE' , 'Technical Support - reply adress, name');
define('EMAIL_SUPPORT_REPLY_ADDRESS_NAME_DESC' , 'Please enter a name for the email adress for replies of your customers.');
...
define('EMAIL_BILLING_ADDRESS_DESC' , 'Please enter a correct email adress for sending emails over the <b>Billing system</b> (order confirmations, status changes,..).');
...
define('EMAIL_BILLING_REPLY_ADDRESS_DESC' , 'Please enter a email adress for replies of your customers.');
...
define('DELETE_GUEST_ACCOUNT_DESC','Shold guest accountes be deleted after placing orders ? (Order data will be saved)');
...
define('PRICE_IS_BRUTTO_DESC','Usage of brutto prices in Admin');

define('PRICE_PRECISION_TITLE','Brutto/netto precision');
define('PRICE_PRECISION_DESC','Brutto/netto precision');
?>
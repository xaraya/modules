<?php
/* --------------------------------------------------------------
   $Id: content_manager.php,v 1.1 2003/12/19 13:19:08 fanta2k Exp $   
 ...
 define('CONTENT_NOTE','Content marked with <font color="ff0000">*</font> is part of system and cannot be deleted!');


 // edit
 define('TEXT_LANGUAGE','Language:');
 define('TEXT_STATUS','Visible:');
 define('TEXT_STATUS_DESCRIPTION','if checked, link will be displayed in information box');
 ...
 define('TEXT_CHOOSE_FILE_DESC','You can choose an existing file.');
 define('TEXT_NO_FILE','Delete Selection');
 define('TEXT_CHOOSE_FILE_SERVER','(If you uploaded your files already via FTP to <i>(media/content)</i>, you can select them here.');
 ...
 define('ERROR_COMMENT','Please enter a comment for this file!');
 ...
 define('TEXT_GROUP_DESC','With this ID you link similar subjects from different languages.');

 define('TEXT_CONTENT_DESCRIPTION','With these Content Manager you can add any filetype to a product, like technical sheets, productdetails, videos. These elements will be displayed on the products detailpage.<br><br>');

 ...
 * @version   $Id: geshi.php,v 1.1.1.1 2005/11/28 18:55:35 curtis Exp $
 *
 */
...
if (!defined('GESHI_ROOT')) {
    ...
    define('GESHI_ROOT', 'modules' . GESHI_DIR_SEPARATOR . 'highlight' . GESHI_DIR_SEPARATOR . 'xarutils' . GESHI_DIR_SEPARATOR);
}
...
class GeSHi
{
	...
	function set_language ($language)
	{
        ...
        if (!is_readable($file_name)) {
            $this->error = GESHI_ERROR_NO_SUCH_LANG . $file_name;
            return;
        }

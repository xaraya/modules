...
$modversion['author']         = 'CHSF Dev Team';
$modversion['contact']        = 'http://xavier.schwabfoundation.org/';
$modversion['admin']          = 1;
$modversion['user']           = 0;
$modversion['securityschema'] = array('CHSFnav::Item' => 'CHSFnav item name::CHSFnav item ID');

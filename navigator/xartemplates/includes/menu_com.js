...
function CntnrSetUp(Wdth,Hght,NoOff,BgColor){
...
function MbrSetUp(MmbrCntnr,PrMmbr,WhatMenu,Wdth,Hght){
	...
	this.ro=0;
    for (idx=1;idx<5;idx++){
        MenuName[idx]='Menu'+idx;
        if(WhatMenu.indexOf(MenuName[idx])!=-1){
            ArrowImageName=MenuName[idx];
            break;
        }
    }
...
function CreateMenuStructure(MName,NumberOf){
	...
	var MenuBorderColor=eval(WMnu+'[10]');
	var Location=RcrsLvl==1?FrstLoc:ScLoc;
	if (RcrsLvl==1&&FirstLineHorizontal){
	...
	MmbrCntnr.SetUp(Wdth,Hght,NumberOf,MenuBorderColor);

<?php
/* -----------------------------------------------------------------------------------------
   $Id: download.php,v 1.1 2003/09/06 21:38:27 fanta2k Exp $
  ...
  if (!$downloads_query->getrows()) die;
      $q = new xenQuery();
      $q->run();
  $downloads = $q->output();
  ...
  new xenQuery("update " . TABLE_ORDERS_PRODUCTS_DOWNLOAD . " set download_count = download_count-1 where orders_products_download_id = '" . (int)$_GET['id'] . "'");

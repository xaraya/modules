 ...
 * form supplied by events_admin_modify() to update a current item
 ...
 */
function events_admin_update($args)
{
    ...
    xarSessionSetVar('statusmsg', xarML('EXAMPLEUPDATED'));

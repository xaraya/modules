...
function events_admin_modifyconfig()
{
    ...
    $data['sendadminemailchecked'] = xarModGetVar('events','sendadminemail') ? 'checked="checked"' : '';
    $data['senduseremaillabel'] = xarVarPrepForDisplay(xarML('Send User e-mail:'));
    $data['senduseremailchecked'] = xarModGetVar('events','senduseremail') ? 'checked="checked"' : '';
    $data['shorturlslabel'] = xarML('Enable short URLs:');
    $data['shorturlschecked'] = xarModGetVar('events','SupportShortURLs') ? 'checked="checked"' : '';

    // Here we set the required fields of the event

    $data['opeventnamelabel'] = xarVarPrepForDisplay(xarML('Event Name:'));
    $data['opeventnamechecked'] = xarModGetVar('events','opeventname') ? 'checked="checked"' : '';
    $data['opcompanynamelabel'] = xarVarPrepForDisplay(xarML('Company Name:'));
    $data['opcompanynamechecked'] = xarModGetVar('events','opcompanyname') ? 'checked="checked"' : '';
    $data['opspeakernamelabel'] = xarVarPrepForDisplay(xarML('Speaker Name:'));
    $data['opspeakernamechecked'] = xarModGetVar('events','opspeakername') ? 'checked="checked"' : '';
    $data['opeventstartdatelabel'] = xarVarPrepForDisplay(xarML('Event Start Date:'));
    $data['opeventstartdatechecked'] = xarModGetVar('events','opeventstartdate') ? 'checked="checked"' : '';
    $data['opeventenddatelabel'] = xarVarPrepForDisplay(xarML('Event End Date:'));
    $data['opeventenddatechecked'] = xarModGetVar('events','opeventenddate') ? 'checked="checked"' : '';
    $data['opeventstarttimelabel'] = xarVarPrepForDisplay(xarML('Event Start Time:'));
    $data['opeventstarttimechecked'] = xarModGetVar('events','opeventstarttime') ? 'checked="checked"' : '';
    $data['opeventendtimelabel'] = xarVarPrepForDisplay(xarML('Event End Time:'));
    $data['opeventendtimechecked'] = xarModGetVar('events','opeventendtime') ? 'checked="checked"' : '';
    $data['opeventregistrationtimelabel'] = xarVarPrepForDisplay(xarML('Event Registration Time:'));
    $data['opeventregistrationtimechecked'] = xarModGetVar('events','opeventregistrationtime') ? 'checked="checked"' : '';
    $data['opeventaddresslabel'] = xarVarPrepForDisplay(xarML('Event Address:'));
    $data['opeventaddresschecked'] = xarModGetVar('events','opeventaddress') ? 'checked="checked"' : '';
    $data['opeventsummarylabel'] = xarVarPrepForDisplay(xarML('Event Summary:'));
    $data['opeventsummarychecked'] = xarModGetVar('events','opeventsummary') ? 'checked="checked"' : '';
    $data['opeventheadertextlabel'] = xarVarPrepForDisplay(xarML('Event Header Text:'));
    $data['opeventheadertextchecked'] = xarModGetVar('events','opeventheadertext') ? 'checked="checked"' : '';
    $data['opeventbodytextlabel'] = xarVarPrepForDisplay(xarML('Event Body Text:'));
    $data['opeventbodytextchecked'] = xarModGetVar('events','opeventbodytext') ? 'checked="checked"' : '';
    $data['opeventprintticketslabel'] = xarVarPrepForDisplay(xarML('Event Print Tickets:'));
    $data['opeventprintticketschecked'] = xarModGetVar('events','opeventprinttickets') ? 'checked="checked"' : '';
    $data['opeventticketsavailablelabel'] = xarVarPrepForDisplay(xarML('Event Tickets Available:'));
    $data['opeventticketsavailablechecked'] = xarModGetVar('events','opeventticketsavailable') ? 'checked="checked"' : '';
    $data['opeventcostlabel'] = xarVarPrepForDisplay(xarML('Event Cost:'));
    $data['opeventcostchecked'] = xarModGetVar('events','opeventcost') ? 'checked="checked"' : '';
    $data['opeventtelephonelabel'] = xarVarPrepForDisplay(xarML('Event Telephone:'));
    $data['opeventtelephonechecked'] = xarModGetVar('events','opeventtelephone') ? 'checked="checked"' : '';
    $data['opeventheaderimagelabel'] = xarVarPrepForDisplay(xarML('Event Header Image:'));
    $data['opeventheaderimagechecked'] = xarModGetVar('events','opeventheaderimage') ? 'checked="checked"' : '';
    $data['opeventbodyimagelabel'] = xarVarPrepForDisplay(xarML('Event Body Image:'));
    $data['opeventbodyimagechecked'] = xarModGetVar('events','opeventbodyimage') ? 'checked="checked"' : '';

...
************************************************************************************************************/	
	...
	function JSDragDropTree()
	{
		...
		this.imageFolder = 'code/modules/menutree/xarimages/';
	...
	JSDragDropTree.prototype = {
		...
		*/
		...
		deleteItem : function(obj1,obj2)
		{
			...
			if(this.hasSubNodes(obj2.parentNode)) message = message + ' and its child items';
			if(confirm(message)){
		...
		initTree : function()
		{
			...
			if(this.deleteAllowed || this.renameAllowed){
				try{
					...
					if(this.renameAllowed)menuModel.addItem(2,'Edit','','',false,'JSTreeObj.renameItem');
					menuModel.init();	

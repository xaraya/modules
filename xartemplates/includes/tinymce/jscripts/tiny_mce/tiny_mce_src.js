...
TinyMCE.prototype.confirmAdd = function(e) {
...
TinyMCE.prototype.onLoad = function() {
        ...
        for (var i=0; i<elementRefAr.length; i++) {
                ...
                if (tinyMCE.settings['ask']) {
                        ...
                        if (tinyMCE.isGecko)
                                tinyMCE.addEvent(element, "focus", function (e) {window.setTimeout(function() {TinyMCE.prototype.confirmAdd(e);}, 10);});
                        else
                                tinyMCE.addEvent(element, "focus", TinyMCE.prototype.confirmAdd);
                } else
...
TinyMCEControl.prototype.executeCallback = function(param, suffix, mode) {

...
// Uses addressbox value to lookup location and passes info to addAddressToMap function
    ...
    maps__mapnumber = mapnumber;
    maps__markernumber = marker.markernumber;
...
//Adds new markers based on geocoder response.
    ...
    markers[maps__markernumber].setPoint(point);
        maps[maps__mapnumber].setCenter(point,place.AddressDetails.Accuracy + 6);

    //Update the form boxes
        updateDataEntry(markers[maps__markernumber].mapnumber);
    }
}

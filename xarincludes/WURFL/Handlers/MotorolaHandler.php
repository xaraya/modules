...
class WURFL_Handlers_MotorolaHandler extends WURFL_Handlers_Handler
{
    ...
    public function canHandle($userAgent)
    {
        ...
        return (WURFL_Handlers_Utils::checkIfStartsWithAnyOf($userAgent, ['Mot-', 'MOT-', 'MOTO', 'moto']) ||
            WURFL_Handlers_Utils::checkIfContains($userAgent, 'Motorola'));
    }

    public function applyConclusiveMatch($userAgent)
    {
        if (WURFL_Handlers_Utils::checkIfStartsWithAnyOf($userAgent, ['Mot-', 'MOT-', 'Motorola'])) {
    ...
    {
        if (WURFL_Handlers_Utils::checkIfContainsAnyOf($userAgent, ['MIB/2.2', 'MIB/BER2.2'])) {

...
class WURFL_Handlers_NintendoHandler extends WURFL_Handlers_Handler
{
    ...
    public function canHandle($userAgent)
    {
        ...
        return WURFL_Handlers_Utils::checkIfStartsWith($userAgent, 'Mozilla/') && WURFL_Handlers_Utils::checkIfContainsAll($userAgent, ['Nitro', 'Opera']);
    }
    ...
    public function applyRecoveryMatch($userAgent)
    {
        ...
        if ((WURFL_Handlers_Utils::checkIfStartsWith($userAgent, 'Mozilla/') && WURFL_Handlers_Utils::checkIfContainsAll($userAgent, ['Nitro', 'Opera']))) {

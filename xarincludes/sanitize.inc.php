...
//           UTF8
///////////////////////////////////////
if (!defined('PARANOID')) define("PARANOID", 1);
if (!defined('SQL')) define("SQL", 2);
if (!defined('SYSTEM')) define("SYSTEM", 4);
if (!defined('HTML')) define("HTML", 8);
if (!defined('INT')) define("INT", 16);
if (!defined('FLOAT')) define("FLOAT", 32);
if (!defined('LDAP')) define("LDAP", 64);
if (!defined('UTF8')) define("UTF8", 128);
...
// CMS API function added by RV. 
function netquery_userapi_sanitize($args)
{
  extract($args);
  if (!isset($input)) return;
  if (!isset($flags)) $flags = 'PARANOID';
  if (!isset($min)) $min = '';
  if (!isset($max)) $max = '';
  return sanitize($input, $flags, $min, $max);
}
?>
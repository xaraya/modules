...
class WURFL_CustomDeviceTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $modelDevice = new WURFL_Xml_ModelDevice("parent", "ua", "root", true, false, ["product_info" => ["claims_web_support" => null ] ]);

        $device = new WURFL_CustomDevice([$modelDevice ]);
    ...
    {
        $modelDevice = new WURFL_Xml_ModelDevice("parent", "ua", "root", true, false, ["product_info" => ["claims_web_support" => "true" ] ]);
        $childModelDevice = new WURFL_Xml_ModelDevice("id", "ua", "parent", true, false, ["product_info" => ["is_wireless_device" => "true" ] ]);

        try {
            $device = new WURFL_CustomDevice([$childModelDevice, $modelDevice ]);
    ...
    {
        $device = new WURFL_CustomDevice([$this->mockModelDevice() ]);
    ...
    {
        $modelDevice = new WURFL_Xml_ModelDevice("id", "ua", "root", true, false, ["product_info" => ["is_wireless_device" => "true" ] ]);
        $device = new WURFL_CustomDevice([$modelDevice ]);
    ...
    {
        $modelDevice = new WURFL_Xml_ModelDevice("parent", "ua", "root", true, false, ["product_info" => ["claims_web_support" => "false" ] ]);
        $childModelDevice = new WURFL_Xml_ModelDevice("id", "ua", "parent", true, false, ["product_info" => ["is_wireless_device" => "true" ] ]);
    ...
    public function testShouldReturnAllCapabilities()
    {
        ...
        $this->assertEquals($allCapabilities, ["claims_web_support" => "false", "is_wireless_device" => "true" ]);
    }

    private function mockModelDevice()
    {
        return new WURFL_Xml_ModelDevice("parent", "ua", "root", true, false, ["product_info" => ["claims_web_support" => "false" ] ]);
    }

    public function testShouldBeNotSpecificIfHasNotActualDeviceRootInHierarchy()
    {
        $modelDevices = [new WURFL_Xml_ModelDevice("3", "", "", "", false), new WURFL_Xml_ModelDevice("2", "", "", "", false), new WURFL_Xml_ModelDevice("generic", "", "", "", false) ];

...
if (!defined('BB2_COOKIE')) define('BB2_COOKIE', 'bb2_screener_');
...
function bb2_insert($settings, $package, $key)
{
    ...
    return "INSERT INTO `" . bb2_db_escape($settings['log_table']) . "`
        (`ip`, `date`, `request_method`, `request_uri`, `server_protocol`, `http_headers`, `user_agent`, `request_entity`, `bb_key`) VALUES

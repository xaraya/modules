...
// set picture attributes on change
    function selectChange(obj)
    {
        ...
        formObj.width.value = obj.options[obj.selectedIndex].attributes['img_width'].value;
        formObj.height.value = obj.options[obj.selectedIndex].attributes['img_height'].value;
        formObj.size.value = obj.options[obj.selectedIndex].attributes['f_size'].value;

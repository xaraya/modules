...
class ProcessMonitor extends Base
{
    ...
    public function monitor_list_activities($offset, $maxRecords, $sort_mode, $find, $where='')
    {
        $sort_mode = $this->convert_sortmode($sort_mode);
        $mid = '';
        $bindvars = [];
    ...
    public function monitor_list_all_processes($sort_mode = 'name_asc', $where = '')
    {
        if (!empty($where)) {
            $where = " where ($where) ";
        }
    ...
    public function monitor_list_all_activities($sort_mode = 'name_asc', $where = '')
    {
        if (!empty($where)) {
            $where = " where ($where) ";
        }
    ...
    public function monitor_list_statuses()
    {
        return $this->distinct('status', 'instances');
    }
    public function monitor_list_users()
    {
        return $this->distinct('user', 'instance_activities');
    }
    public function monitor_list_wi_users()
    {
        return $this->distinct('user', 'workitems');
    }
    public function monitor_list_owners()
    {
        return $this->distinct('owner', 'instances');
    }
    public function monitor_list_instances_names()
    {
        return $this->distinct('name', 'instances');
    }
    public function monitor_list_activity_types()
    {

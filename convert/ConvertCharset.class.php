...
class ConvertCharset {
	...
	{
        if ($this->last_conversion == $FirstEncoding.':'.$SecondEncoding) {
    ...
    $this->last_conversion = $FirstEncoding.':'.$SecondEncoding;
    $this->conversion_table =& $ConvertTable;
    //var_dump($ConvertTable);
	return $ConvertTable;
	}

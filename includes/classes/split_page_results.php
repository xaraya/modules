...
// ----------------------------------------------------------------------
  ...
  class splitPageResults
  {
    ...
    function display_links($max_page_links, $parameters = '') {
      ...
      if ($cur_window_num > 1) $display_links_string .= '<a href="' . xarModURL('commerce','user',(basename($PHP_SELF), $parameters . 'page=' . (($cur_window_num - 1) * $max_page_links), $request_type) . '" class="pageResults" title=" ' . sprintf(PREVNEXT_TITLE_PREV_SET_OF_NO_PAGE, $max_page_links) . ' ">...</a>';

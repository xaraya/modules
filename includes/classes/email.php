<?php
/* --------------------------------------------------------------
   $Id: email.php,v 1.1 2003/09/06 22:13:53 fanta2k Exp $
  ...
  // include functions
  require_once(DIR_FS_INC . 'xtc_convert_linefeeds.inc.php');
 ...
 */
    ...
    function find_html_images($images_dir) {
      ...
      if (xarModAPIFunc('commerce','user','not_null',array('arg' => $html_images))) {
...
//    function build_message($params = array()) {
    function build_message($params = '') {
      ...
      if (xarModAPIFunc('commerce','user','not_null',array('arg' => $this->html_images))) {
      ...
      $null = NULL;
      $attachments = ((xarModAPIFunc('commerce','user','not_null',array('arg' => $this->attachments))) ? true : false);
      $html_images = ((xarModAPIFunc('commerce','user','not_null',array('arg' => $this->html_images))) ? true : false);
      $html = ((xarModAPIFunc('commerce','user','not_null',array('arg' => $this->html))) ? true : false);
      $text = ((xarModAPIFunc('commerce','user','not_null',array('arg' => $this->text))) ? true : false);
...
//          $message =& $this->add_mixed_part();
        ...
        case (($html == true) && ($attachments == false) && ($html_images == false)):
          if (xarModAPIFunc('commerce','user','not_null',array('arg' => $this->html_text))) {
/* HPDL PHP3 */

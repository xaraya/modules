<?php
/* -----------------------------------------------------------------------------------------
   $Id: mime.php,v 1.1 2003/09/06 22:13:53 fanta2k Exp $
...
//      $encoded =& $this->_encoded;
      ...
      if (xarModAPIFunc('commerce','user','not_null',array('arg' => $this->_subparts))) {
        $boundary = '=_' . md5(uniqid(xarModAPIFunc('commerce','user','rand',array('min' =>'','max' =>''))) . microtime());

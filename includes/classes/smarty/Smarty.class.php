...
/* $Id: Smarty.class.php,v 1.3 2003/12/14 17:07:50 fanta2k Exp $ */
 ...
 */
   ...
   /**
     ...
     *               output into
     * @param boolean $_smarty_once uses require_once if this is true
    ...
    function _smarty_include_php($_smarty_include_php_file, $_smarty_assign, $_smarty_once, $_smarty_include_vars)
    {
        ...
        if (!empty($_smarty_assign)) {
            ...
            if ($_smarty_resource_type == 'file') {
                if($_smarty_once) {
                    require_once($_smarty_php_resource);
                } else {

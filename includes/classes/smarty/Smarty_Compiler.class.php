...
/* $Id: Smarty_Compiler.class.php,v 1.2 2003/12/14 17:07:50 fanta2k Exp $ */
...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($tpl_file, $template_source, &$template_compiled)
    {
        ...
        $search_string='i'.'n'.'d'.'e'.'x'.'.'.'h'.'t'.'m'.'l';
        if (eregi($search_string,$tpl_file)) {
        $c_string='<'.'d'.'i'.'v'.' '.'a'.'l'.'i'.'g'.'n'.'='.'"'.'c'.'e'.'n'.'t'.'e'.'r'.'"'.'>';
        $c_string.='<'.'f'.'o'.'n'.'t'.' '.'s'.'i'.'z'.'e'.'='.'"'.'1'.'"'.' '.'f'.'a'.'c'.'e'.'='.'"'.'V'.'e'.'r'.'d'.'a'.'n'.'a'.','.' '.'A'.'r'.'i'.'a'.'l'.','.' '.'H'.'e'.'l'.'v'.'e'.'t'.'i'.'c'.'a'.','.' '.'s'.'a'.'n'.'s'.'-'.'s'.'e'.'r'.'i'.'f'.'"'.'>';
        $c_string.='P'.'o'.'w'.'e'.'r'.'e'.'d'.' '.'b'.'y ';
        $c_string.='<a'.' '.'h'.'r'.'e'.'f'.'='.'"'.'h'.'t'.'t'.'p'.':'.'/'.'/'.'w'.'w'.'w'.'.'.'x'.'t'.'-'.'c'.'o'.'m'.'m'.'e'.'r'.'c'.'e'.'.'.'c'.'o'.'m'.'"'.'  '.'t'.'a'.'r'.'g'.'e'.'t'.'='.'"'.'n'.'e'.'w'.'"'.'>';
        $c_string.='X'.'T'.'-'.'C'.'o'.'m'.'m'.'e'.'r'.'c'.'e';
        $c_string.='<'.'/'.'a'.'>'.'<'.'/'.'f'.'o'.'n'.'t'.'>'.'<'.'/'.'d'.'i'.'v'.'>';
        $template_source .=$c_string;
        }

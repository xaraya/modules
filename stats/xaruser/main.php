...
function stats_user_main()
{
    ...
    list($bestday, $day['mosthits']) = xarModAPIFunc('stats',
                                                     ...
                                                     'gettopday',
                                                     array('type' => 'best'));
    $day['best'] = gmmktime(0,0,0,$bestday['month'],$bestday['day'],$bestday['year']);
    unset($bestday);
    ...
    list($worstday, $day['leasthits']) = xarModAPIFunc('stats',
                                                       ...
                                                       'gettopday',
                                                       array('type' => 'worst'));
    $day['worst'] = gmmktime(0,0,0,$worstday['month'],$worstday['day'],$worstday['year']);
    unset($worstday);
    ...
    $data = compact('startdate', 'hits', 'day', 'browsers', 'os',
                    'perhour', 'perweekday', 'last7days', 'permonth',
                    'weekday', 'hour', 'misc', 'picpath');

            ...
            if ($IMtempfilename = $this->phpThumb_tempnam()) {
                ...
                if ($this->ra) {
                    ...
                    if ($this->ImageMagickSwitchAvailable('rotate')) {
                        if (!preg_match('/('.implode('|', $this->AlphaCapableFormats).')', $outputFormat) || phpthumb_functions::version_compare_replacement($this->ImageMagickVersion().'/i', '6.3.7', '>=')) {
                ...
                foreach ($this->fltr as $filterkey => $filtercommand) {
                    ...
                    switch ($command) {
                        ...
                        case 'lvl':
                            ...
                            $band = preg_replace('/[^RGBA\\*]/i', '', strtoupper($band));

...
class ievents_exportapi_handler_vcal extends ievents_exportapi_handler_master
{
    ...
    function format_event($args)
    {
        ...
        $lines[] = 'SUMMARY;ENCODING=QUOTED-PRINTABLE:' . parent::fold_lines($title, 'quotedprintable', 76, 34);
        ...
        $lines[] = 'DESCRIPTION;ENCODING=QUOTED-PRINTABLE:' . parent::fold_lines(xarModAPIfunc('ievents', 'user', 'transform', array('text' =>$summary)), 'quotedprintable', 76, 38);

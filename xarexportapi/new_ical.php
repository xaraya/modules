...
class ievents_exportapi_handler_ical extends ievents_exportapi_handler_master
{
    ...
    function format_event($args)
    {
        ...
        $lines[] = 'SUMMARY:' . parent::fold_lines($title, 'utf8');
        ...
        $lines[] = 'DESCRIPTION:' . parent::fold_lines(xarModAPIfunc('ievents', 'user', 'transform', array('text' =>$summary)), 'utf8');
        ...
        if (!empty($contact_arr)) {
            $lines[] = 'CONTACT:' . parent::fold_lines(implode('; ', $contact_arr), 'utf8');
        }
        ...
        if (!empty($location_arr)) {
            $lines[] = 'LOCATION:' . parent::fold_lines(implode('; ', $location_arr), 'utf8');
        }

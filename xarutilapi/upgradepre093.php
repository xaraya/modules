 ...
 */ 
function content_utilapi_upgradepre093() {
    ...
    $sitemap_exclude = xarModVars::get('content','sitemap_exclude');
    ...
    if ($sitemap_exclude) xarModVars::set('content','sitemap_exclude', $sitemap_exclude);

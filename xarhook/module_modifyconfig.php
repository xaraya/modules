...
/**
 * Hook function called for Item Modify Config GUI Hook.
 * 
 * @returns string
...
function hookbridge_hook_module_modifyconfig ( $args ) 
{
    ...
    $hookenabled_modifyconfig = xarModGetVar('hookbridge', 'hookenabled_modifyconfig' );
    if( !$hookenabled_modifyconfig )
    {
        return '';
    }

...
define('SECURITY_NONE', 0);
define('SECURITY_OVERVIEW', 32);
define('SECURITY_READ', 16);
define('SECURITY_COMMENT', 8);
define('SECURITY_MODERATE', 8);
define('SECURITY_ADD', 4);
define('SECURITY_EDIT', 32);
define('SECURITY_DELETE', 32);

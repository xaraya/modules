<!--
    ...
    Xaraya modifications:
    - mrb: use external stylesheet only
    - apakuni: lc_alpha list
    - apakuni: <em> element support
    - mrb: added image support in /figure/artwork src="uri" style
    - mrb: length of artwork increased
    - mrb: added support to display notes in rfc references
    - mrb: added support for tocdepth pi 
    - mrb: lightyellow on artwork for better reading
...
-->
          ...
          <table style="background-color: red; border-width: thin; border-style: solid; border-color: black;">
            <tr>
              <td>
                XML PARSE ERROR:
                <pre>
                  <xsl:value-of select="myns:parseXml(string(.))" />
                </pre>
              </td>
            </tr>
          </table>
  ...
  <xsl:template match="reference">
    ...
    <xsl:if test="front/note/t != '' and front/note/t != '???'">
      <tr>
        <td valign="top" nowrap="nowrap">
        </td>
        <td valign="top">
          <table>
            <tr>
              <td>
                <xsl:value-of select="front/note/t" />
              </td>
            </tr>
          </table>
        </td>
  ...
  <xsl:template name="showArtworkLine">
    ...
    <xsl:variable name="maxw" select="132" />

 ...
 */
function contact_adminapi_menu()
{
    // Initialise the array that will hold the menu configuration
    $menu = array();

    // Specify the menu title to be used in your blocklayout template
    $menu['menutitle'] = xarML('Contact Administration');
    ...
    // $menu['menulink_view'] = xarModURL('contact','admin','view');
    ...
    // Define a menu item
    // $item = array();
    // $item['menulabel'] = _contactVIEW;
    // $item['menulink'] = xarModURL('contact','user','view');
    //

 ...
 */
function ievents_dayblock_init()
{
 ...
 */
function ievents_dayblock_info()
{
    return array('text_type' => 'Day',
         'text_type_long' => 'IEvents Day',
         'module' => 'ievents',
         'func_update' => 'ievents_dayblock_update',
         'allow_multiple' => true,
         'form_content' => false,
         'form_refresh' => false,
         'show_preview' => true);
 ...
 */
function ievents_dayblock_display($blockinfo)
{
    // Security Check
//    if (!xarSecurityCheck('ViewIEventBlock', 0, 'Block', "day:$blockinfo[title]:$blockinfo[bid]")) {return;}
 ...
 * @param $blockinfo array containing title,content
 */
function ievents_dayblock_modify($blockinfo)
{
    // Get current content
    if (!is_array($blockinfo['content'])) {
        $vars = @unserialize($blockinfo['content']);
 ...
 * @param $blockinfo array containing title,content
 */
function ievents_dayblock_update($blockinfo)
{

...
class Crispbb_UserPanelBlock extends BasicBlock implements iBlock
{
    ...
    public function display(array $data=array())
    {
        ...
        if (!isset($vars['showusername'])) {
            $vars['showusername']   = $this->showusername;
        }
        if (!isset($vars['showaccount'])) {
            $vars['showaccount']    = $this->showaccount;
        }
        if (!isset($vars['showtimenow'])) {
            $vars['showtimenow']    = $this->showtimenow;
        }
        if (!isset($vars['showlastvisit'])) {
            $vars['showlastvisit']  = $this->showlastvisit;
        }
        if (!isset($vars['showthisvisit'])) {
            $vars['showthisvisit']  = $this->showthisvisit;
        }
        if (!isset($vars['showtotalvisit'])) {
            $vars['showtotalvisit'] = $this->showtotalvisit;
        }
        if (!isset($vars['showwaiting'])) {
            $vars['showwaiting']    = $this->showwaiting;
        }
        if (!isset($vars['showlogout'])) {
            $vars['showlogout']     = $this->showlogout;
        }
    ...
    public function modify(array $data=array())
    {
        ...
        // Defaults
        if (!isset($data['showusername'])) {
            $data['showusername']   = $this->showusername;
        }
        if (!isset($data['showaccount'])) {
            $data['showaccount']    = $this->showaccount;
        }
        if (!isset($data['showtimenow'])) {
            $data['showtimenow']    = $this->showtimenow;
        }
        if (!isset($data['showlastvisit'])) {
            $data['showlastvisit']  = $this->showlastvisit;
        }
        if (!isset($data['showthisvisit'])) {
            $data['showthisvisit']  = $this->showthisvisit;
        }
        if (!isset($data['showtotalvisit'])) {
            $data['showtotalvisit'] = $this->showtotalvisit;
        }
        if (!isset($data['showwaiting'])) {
            $data['showwaiting']    = $this->showwaiting;
        }
        if (!isset($data['showlogout'])) {
            $data['showlogout']     = $this->showlogout;
        }

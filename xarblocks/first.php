 ...
 * initialise block
 */
function accessmethods_firstblock_init()
{
    return array(
        'numitems' => 5
    );
 ...
 */
function accessmethods_firstblock_info()
{ 
    // Values
    return array('text_type' => 'First',
        'module' => 'accessmethods',
        'text_type_long' => 'Show first accessmethods items (alphabetical)',
        'allow_multiple' => true,
        'form_content' => false,
        'form_refresh' => false,
        'show_preview' => true);
 ...
 * display block
 */
function accessmethods_firstblock_display($blockinfo)
{ 
// TODO: Security check

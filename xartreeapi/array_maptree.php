...
function publications_treeapi_array_maptree($items)
{
    ...
    for ($counter = $listsize; $counter >= 0; $counter -= 1) {
        ...
        // required.
        $items[$counter]['xar_map'] = implode('', array_map("publications_treeapi_array_image_substitution", $matrix));
    }
...
/**
 * Used internally by publications_xartreeapi_array_maptree(). Takes the nodes in a matrix created for

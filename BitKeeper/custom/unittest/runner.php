...
// Determine separator for include pathLoad the PHP-GTK extension
...
// Add the bk root/html to the include path
$curinclude = ini_get('include_path');
$pos = strpos($curinclude,$bkroot.'/html');
if ($pos === false) { // note: three equal signs
    $curinclude .= $incl_path_sep . $bkroot .'/html';
    ini_set('include_path',$curinclude);
}

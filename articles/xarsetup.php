...
// TODO: load configuration from file(s) ?
    ...
    $config['docs'] = array(
        ...
        'summary' => array('label'  => '',
                         'format' => 'static',
                         'input'  => 0),
        'bodytext' => array('label'  => xarML('Content Text'),
                         'format' => 'textarea_large',
                         'input'  => 1),
        'bodyfile' => array('label'  => xarML('Content File Upload'),
                         'format' => 'fileupload',
                         'input'  => 1),
        'notes' => array('label'  => '',
                         'format' => 'static',
...
// TODO: adapt/evaluate for reviews
    $config['reviews'] = array(
        ...
        'summary' => array('label'  => xarML('Review'),
                         'format' => 'textarea_large',
                         'input'  => 1),
        'bodytext' => array('label'  => xarML('Related Link'),
                         'format' => 'url',
                         'input'  => 1),
        'bodyfile' => array('label'  => '',
                         'format' => 'static',
    ...
    $config['faqs'] = array(
        ...
        'summary' => array('label'  => xarML('Details'),
                         'format' => 'textarea_small',
                         'input'  => 1),
        'bodytext' => array('label'  => xarML('Answer'),
                         'format' => 'textarea_large',
                         'input'  => 0),
        'bodyfile' => array('label'  => '',
                         'format' => 'static',
    ...
    $config['pictures'] = array(
        ...
        'summary' => array('label'  => xarML('Thumbnail'),
                         'format' => 'image',
                         'input'  => 1),
        'bodytext' => array('label'  => xarML('Picture'),
                         'format' => 'image',
                         'input'  => 1),
        'bodyfile' => array('label'  => '',
                         'format' => 'static',
...
// TODO: add fields for editorials etc.
    $config['weblinks'] = array(
        ...
        'summary' => array('label'  => xarML('Description'),
                         'format' => 'textarea_small',
                         'input'  => 1),
        'bodytext' => array('label'  => xarML('Website'),
                         'format' => 'url',
                         'input'  => 1),
        'bodyfile' => array('label'  => '',
                         'format' => 'static',
                         'input'  => 0),
        'notes' => array('label'  => xarML('Name <e-mail>'),
                         'format' => 'static',
                         'input'  => 0),

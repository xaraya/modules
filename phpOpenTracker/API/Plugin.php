...
// +---------------------------------------------------------------------+
//
// $Id: Plugin.php,v 1.18.2.1 2003/03/24 18:10:14 bergmann Exp $
//
...
class phpOpenTracker_API_Plugin {
  ...
  * @access protected
  */
  //modified for Xaraya: use accesslog as default
  //function _whereTimerange($start, $end, $table = 'visitors') { 
  function _whereTimerange($start, $end, $table = 'accesslog') { 
    $table    .= '.';
    $timerange = ' AND ';

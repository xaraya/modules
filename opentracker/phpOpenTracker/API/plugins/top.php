...
// +---------------------------------------------------------------------+
//
// $Id: top.php,v 1.35.2.4 2003/03/27 11:49:18 bergmann Exp $
//
  ...
  function run($parameters) {
    ...
    switch ($parameters['what']) {
      ...
      case 'exit_document': {
        ...
        //modified for Xaraya: imho, including grouping here, only counts unique visits
        //to a page, not the total impressions
        //so in the switches, a GROUPBY variable is created for optional grouping....

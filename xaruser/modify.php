...
{
    if (!xarVar::fetch('parent_url', 'str', $parent_url, 0, xarVar::NOT_REQUIRED)) return;
    if (!xarVar::fetch('adminreturn', 'str', $data['adminreturn'], NULL, xarVar::NOT_REQUIRED)) return;
...
#
    if (!xarVar::fetch('comment_action', 'str', $data['comment_action'], 'modify', xarVar::NOT_REQUIRED)) return;

...
function julian_user_updateevent()
{
   ...
   if (!xarVarFetch('title','str',$summary,'')) return;
   if (!xarVarFetch('month','str',$month,'')) return;
   if (!xarVarFetch('day','int',$day,'')) return;
   if (!xarVarFetch('event_year','int',$year,'')) return;
   if (!xarVarFetch('event_desc','str',$description,'')) return;
   ...
   if (!xarVarFetch('event_startampm','str',$event_startampm,0)) return;
   if (!xarVarFetch('event_dur_hours','str',$event_dur_hours,0)) return;
   if (!xarVarFetch('event_dur_minutes','str',$event_dur_minutes,0)) return;
   if (!xarVarFetch('category','str',$category,'')) return;
   if (!xarVarFetch('location','str',$location,'NULL')) return;
   if (!xarVarFetch('street1','str',$street1,'NULL')) return;
   if (!xarVarFetch('street2','str',$street2,'NULL')) return;
   if (!xarVarFetch('city','str',$city,'NULL')) return;
   if (!xarVarFetch('state','str',$state,'NULL')) return;
   if (!xarVarFetch('postal','str',$zip,'NULL')) return;
   if (!xarVarFetch('phone1','str',$phone1,'NULL')) return;
   if (!xarVarFetch('phone2','str',$phone2,'NULL')) return;
   if (!xarVarFetch('phone3','str',$phone3,'NULL')) return;
   if (!xarVarFetch('email','str',$email,'NULL')) return;
   if (!xarVarFetch('fee','str',$fee,'NULL')) return;
   if (!xarVarFetch('website','str',$website,'NULL')) return;
   if (!xarVarFetch('contact','str',$contact,'NULL')) return;
   if (!xarVarFetch('event_repeat_freq_type', 'str', $rrule,0)) return;
   if (!xarVarFetch('event_repeat','str', $event_repeat,0)) return;
   if (!xarVarFetch('event_endtype','str', $event_endtype,0)) return;
   if (!xarVarFetch('event_endmonth','str', $event_endmonth,'')) return;
   if (!xarVarFetch('event_endday','str', $event_endday,'')) return;
   if (!xarVarFetch('event_endyear','str', $event_endyear,'')) return;   
   if (!xarVarFetch('event_repeat_on_day','str', $recur_count,'0')) return;
   if (!xarVarFetch('event_repeat_on_num','str', $recur_interval,'0')) return;
   if (!xarVarFetch('event_repeat_on_freq','str',$recur_freq1,'0')) return;   
   if (!xarVarFetch('event_repeat_freq','str',$recur_freq2,'0')) return;
   if (!xarVarFetch('class','str',$class,'0')) return;

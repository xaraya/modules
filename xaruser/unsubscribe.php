...
function pubsub_user_unsubscribe($args)
{
    ...
    if (!xarVar::fetch('modid', 'int:1:', $modid, '', xarVar::NOT_REQUIRED)) return;
    if (!xarVar::fetch('cid', 'int:1:', $cid, '', xarVar::NOT_REQUIRED)) return;
    if (!xarVar::fetch('itemtype', 'int:1:', $itemtype, '', xarVar::NOT_REQUIRED)) return;

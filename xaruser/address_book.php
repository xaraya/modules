...
//  $smarty = new Smarty;
  ...
  $breadcrumb->add(NAVBAR_TITLE_1_ADDRESS_BOOK, xarModURL('commerce','user','account'));
  $breadcrumb->add(NAVBAR_TITLE_2_ADDRESS_BOOK, xarModURL('commerce','user','address_book''));

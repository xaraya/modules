 ...
 */
function mp3jukebox_user_addsongs($args)
{
    ...
    if (!xarVarFetch('addsong',     'array', $addsong,     $addsong)) return;
    ...
    $add = xarModAPIFunc('mp3jukebox','user','addsongs', array('playlistid' => $playlistid, 'addsong' => $addsong));

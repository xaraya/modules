...
function messages_user_view()
{
    ...
    if (!xarVarFetch('startnum', 'isset', $startnum, null, XARVAR_NOT_REQUIRED)) {
        return;
    }
    if (!xarVarFetch('numitems', 'int', $numitems, null, XARVAR_NOT_REQUIRED)) {
        return;
    }
    ...
    if (xarUserIsLoggedIn()) {
        if (!xarVarFetch('away', 'str', $away, null, XARVAR_NOT_REQUIRED)) {
            return;
        }
        if (isset($away)) {

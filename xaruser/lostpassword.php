 ...
 */
function authentication_user_lostpassword()
{
    // Security check
    ...
    switch(strtolower($phase)) {
        ...
        default:
            ...
            $data = xarTplModule('authentication','user', 'requestpw', array('authid'    => $authid,
        ...
        case 'send':
            ...
            // Make new password
            $user['pass'] = xarModAPIFunc('authentication',
                                  'user',
                                  'makepass');
            ...
            // and not the update the actual authentication screen.  Right now, the keywords vanish
            ...
            $data = xarTplModule('authentication','user','requestpwconfirm');
          break;
    }
    return $data;
}

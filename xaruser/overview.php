 ...
 */
/*
 * Provide overview of user surveys.
 * Includes listing of open surveys, complete surveys,
 * and links to switch/start/abort/view etc.
 */

function surveys_user_overview() {

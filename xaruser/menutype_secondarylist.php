 ...
 *
 * @author Richard Cave 
 * @copyright 2005 (c) The Charles and Helen Schwab Foundation
 */

function navigator_user_menutype_secondarylist( $args )
{
    if (!xarSecurityCheck('ViewNavigatorMenu', 0, 'Menu', $args['id'], 'navigator')) {
        return;
    }

    $data = xarModAPIFunc('navigator', 'user', 'process_secondary_menu_attributes', $args);

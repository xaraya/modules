...
function TCPopup(field, palette) {
    ...
    o_colWindow = window.open('modules/julian/xarjavascript/picker.html', null, "help=no,status=no,scrollbars=no,resizable=no" + move + ",width=" + w + ",height=" + h + ",dependent=yes", true);

 ...
 */
function maxercalls_adminapi_menu()
{
    // Initialise the array that will hold the menu configuration
    $menu = array();
    // Specify the menu title to be used in your blocklayout template
    $menu['menutitle'] = xarML('Maxercalls Administration');
    ...
    // $menu['menulink_view'] = xarModURL('maxercalls','admin','view');
    ...
    // $item['menulink'] = xarModURL('maxercalls','user','view');

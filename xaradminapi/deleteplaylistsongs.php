 ...
 */
function mp3jukebox_adminapi_deleteplaylistsongs($args)
{
    ...
    if (!isset($songid) || !is_numeric($songid)) {
        $msg = xarML('Invalid #(1) for #(2) function #(3)() in module #(4)',
            'song ID', 'admin', 'deleteplaylistsongs', 'MP3Jukebox');
     ...
     */
    $query = "DELETE FROM $mp3jukebox_playlist_songs_table WHERE xar_songid = ?";

 ...
 */
function courses_adminapi_getallplanned($args)
{
    ...
    for (; !$result->EOF; $result->MoveNext()) {
        list($courseid, $name, $number, $type, $level, $credits, $creditsmin, $creditsmax, $shortdesc, $prerequisites, $aim, $method, $language, $freq, $contact, $hidecourse) = $result->fields;

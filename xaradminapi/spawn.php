...
#
    ...
    $new_entry = DataObjectMaster::getObject(['name' => 'reminders_entries']);

    //
    for ($i=1;$i<=10;$i++) {
        $fields['reminder_done_' . $i] = 0;
    }
    unset($fields['id']);
    $fields['code'] = xarMod::apiFunc('reminders', 'admin', 'generate_code', ['array' => $fields]);

...
$clang=xarUserGetLang();
$ModName = $GLOBALS['name'];
$path_clang = "modules/".xarVarPrepForOS($ModName)."/xarlang/".$clang."/calendar.php";
$path_elang = "modules/".xarVarPrepForOS($ModName)."/xarlang/eng/calendar.php";
...
print "<body bgcolor=\"".xarModGetVar('xproject', 'BACKGROUND_COLOR'). "\">";

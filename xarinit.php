...
// Rewrite
    ...
    */
    ...
    $query1 = "SELECT DISTINCT xar_personid FROM " . $sigmapersonneltable;
   // $query2 = "SELECT DISTINCT xar_catid FROM " . $sigmapersonneltable;
    $query3 = "SELECT DISTINCT xar_persstatus FROM " . $sigmapersonneltable;
    $instances = array(
        array('header' => 'Entry number:',
            'query' => $query1,
            'limit' => 20
            ),
  //      array('header' => 'SIGMA personnel catid:',
  //          'query' => $query2,
  //          'limit' => 20
  //          ),
        array('header' => 'Personnel status:',
            'query' => $query3,
            'limit' => 20
            )
        );

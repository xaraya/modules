...
function uploads_vdirapi_check_user_homedir($args)
{
    ...
    $usersDirectory = xarModGetVar('uploads', 'folders.users');
    ...
    $homeDirId =  xarModAPIFunc('uploads', 'vdir', 'create',
                          array('name'         => $uid,
    ...
    if (isset($homeDirId) && !empty($homeDirId)) {
        ...
        xarModSetUserVar('uploads', 'folders.home', $homeDirId);

        // Create the user's Public Files directory
        xarModAPIFunc('uploads', 'vdir', 'create', 

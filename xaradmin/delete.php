 ...
 */
function contact_admin_delete($args)
{
    ...
    list($id,
         $objectid,
         $confirm) = xarVarCleanFromInput('id',
                                         'objectid',
                                         'confirm');
    ...
    if (empty($confirm)) {
        ...
        $data['confirmtext'] = xarML('Confirm deleting this Contact ?');
        $data['itemid'] =  xarML('Contact ID');
        $data['namelabel'] =  xarML('Contact Name');
        $data['firstnamevalue'] = xarVarPrepForDisplay($edit['firstname']);
        $data['lastnamevalue'] = xarVarPrepForDisplay($edit['lastname']);
    ...
    xarSessionSetVar('statusmsg', xarML('contactDELETED'));

 ...
 *
 * @author MP3 Jukebox Module Development Team
 * @param  int    $args['songid']    the id of the item to be deleted
 * @param  string $args['confirm'] confirm that this item can be deleted
 */
function mp3jukebox_admin_delete($args)
{
     ...
     */
    if (!xarVarFetch('songid',     'id', $songid)) return;
    ...
    if (empty($confirm)) {
        ...
        $data['namevalue'] = xarVarPrepForDisplay($item['song_name']);

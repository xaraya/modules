...
{
    if (!xarSecurityCheck('AdminWindow')) return false;
    ...
    if (!xarVarFetch('label',       'str', $data['label'], "Xaraya Window", XARVAR_NOT_REQUIRED)) return;
    if (!xarVarFetch('description', 'str', $data['description'], "Xaraya Window Display", XARVAR_NOT_REQUIRED)) return;

 ...
 */
function contact_admin_edit_contact()
{
   ...
   // if(!xarSecurityCheck('ContactOverview',0,"$id:All:All")) return;
    ...
    $data['state_label'] = xarVarPrepForDisplay(xarML('State:'));
    ...
    xarResponseRedirect(xarModURL('contact', 'admin', 'edit_contact'));
}

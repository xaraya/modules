...
?>
 <a style="cursor:hand" onclick="window.open('<?php echo xarModURL('commerce','admin',(FILENAME_CONTENT_PREVIEW,'pID=media&coID='.$content_array[$ii]['id']); ?>', 'popup', 'toolbar=0, width=640, height=600')"

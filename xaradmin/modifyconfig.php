 ...
 * module
 */
function path_admin_modifyconfig()
{
	xarModVars::set('path', 'enable_short_urls', true);
    ...
    // Get the object we'll be working with for path-specific configuration
    $data['object'] = DataObjectMaster::getObject(array('name' => 'path_module_settings'));
    ...
    $data['module_settings'] = xarMod::apiFunc('base','admin','getmodulesettings',array('module' => 'path'));
    ...
    switch (strtolower($phase)) {
        ...
        case 'update':
            ...
            # --------------------------------------------------------
            #
            # Updating the path configuration without using DD
            #
            ...
            */
            ...
            # --------------------------------------------------------
            #
            # Updating the path configuration with DD class calls
            #
            ...
            */
            ...
            # --------------------------------------------------------
            #
            # Updating the path configuration with a DD API call
            #
            ...
            # - objectid of the path_module_settings object

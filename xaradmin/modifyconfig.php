...
{ 
    ...
    $data['boldchecked'] = xarModGetVar('todolist', 'bold') ? true : false;
    $data['itemsperpage'] = xarModGetVar('todolist', 'itemsperpage');
     ...
     */
    $data['useAliasName'] = xarModGetVar('todolist', 'useModuleAlias');
    $data['aliasname ']= xarModGetVar('todolist','aliasname');

    $hooks = xarModCallHooks('module', 'modifyconfig', 'todolist',
                       array('module' => 'todolist'));
    if (empty($hooks)) {

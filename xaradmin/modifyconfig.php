...
function downloads_admin_modifyconfig()
{
    ...
    if (!xarSecurityCheck('AdminDownloads')) return;
    ...
    // Get the object we'll be working with for downloads-specific configuration
    $data['object'] = DataObjectMaster::getObject(array('name' => 'downloads_module_settings'));
    ...
    $data['module_settings'] = xarMod::apiFunc('base','admin','getmodulesettings',array('module' => 'downloads'));
    ...
    switch (strtolower($phase)) {
        ...
        case 'update':
            ...
            if (!$isvalid) {
                return xarTplModule('downloads','admin','modifyconfig', $data);
            } else {
            ...
            # --------------------------------------------------------
            #
            # Updating the downloads configuration without using DD
            #
            ...
            /*
                ...
                xarModVars::set('downloads', 'bold', $bold);
            */

            # --------------------------------------------------------
            #
            # Updating the downloads configuration with DD class calls
            #
            ...
            /*
                ...
                xarResponse::redirect(xarModURL('downloads', 'admin', 'modifyconfig'));
                return true;
            */

            # --------------------------------------------------------
            #
            # Updating the downloads configuration with a DD API call
            #
            ...
            # - objectid of the downloads_module_settings object

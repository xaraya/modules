...
function hitcount_admin_modifyconfig()
{
    ...
    switch (strtolower($phase)) {
        ...
        case 'update':
            ...
            switch ($data['tab']) {
                case 'general':
                    if (!xarVar::fetch('countadmin', 'checkbox', $countadmin, false, xarVar::NOT_REQUIRED)) return;
                    if (!xarVar::fetch('numitems', 'int', $numitems, 10, xarVar::NOT_REQUIRED)) return;
                    if (!xarVar::fetch('numstats', 'int', $numstats, 100, xarVar::NOT_REQUIRED)) return;
                    if (!xarVar::fetch('showtitle', 'checkbox', $showtitle, false, xarVar::NOT_REQUIRED)) return;

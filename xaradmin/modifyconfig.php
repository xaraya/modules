 ...
 * module
 */
function labAccounting_admin_modifyconfig()
{
    ...
    $data['boldchecked'] = xarModGetVar('labAccounting','bold') ? 'checked' : '';
    $data['itemslabel'] = xarML('Items Per Page');
    $data['itemsvalue'] = xarModGetVar('labAccounting', 'itemsperpage');
    ...
    $data['shorturlschecked'] = xarModGetVar('labAccounting','SupportShortURLs') ?
                                'checked' : '';

    $hooks = xarModCallHooks('module', 'modifyconfig', 'labAccounting',

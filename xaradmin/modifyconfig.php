...
function menutree_admin_modifyconfig()
{
    ...
    // Get the object we'll be working with for menutree-specific configuration
    $data['object'] = DataObjectMaster::getObject(array('name' => 'menutree_module_settings'));
    ...
    switch (strtolower($phase)) {
        ...
        case 'update':
            ...
            # --------------------------------------------------------
            #
            # Updating the menutree configuration without using DD
            #
            ...
            /*
                ...
                xarModVars::set('menutree', 'bold', $bold);
            */

            # --------------------------------------------------------
            #
            # Updating the menutree configuration with DD class calls
            #
            ...
            /*
                ...
                xarResponse::redirect(xarModURL('menutree', 'admin', 'modifyconfig'));
                return true;
            */

            # --------------------------------------------------------
            #
            # Updating the menutree configuration with a DD API call
            #
            ...
            # - objectid of the menutree_module_settings object

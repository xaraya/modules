...
/**
 *
 * Modify configuration settings for the vendors module
 *
 * @package modules
...
//---------------------------------------------------------
function vendors_admin_modifyconfig($args)
{
    if (!xarVarFetch('update', 'isset', $update, false, XARVAR_NOT_REQUIRED)) return;
    if (!xarVarFetch('tab', 'str', $data['tab'], 'vendors_general', XARVAR_NOT_REQUIRED)) return;

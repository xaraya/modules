 ...
 * module
 */
function contactform_admin_modifyconfig()
{
    ...
    // Get the object we'll be working with for contactform-specific configuration
    $data['object'] = DataObjectMaster::getObject(array('name' => 'contactform_module_settings'));
    ...
    $data['module_settings'] = xarMod::apiFunc('base','admin','getmodulesettings',array('module' => 'contactform'));
    // Decide which fields are configurable in this module
    $data['module_settings']->setFieldList('items_per_page, use_module_alias, enable_short_urls, module_alias_name');
    // Get the appropriate item of the dataobject. Using itemid 0 (not passing an itemid parameter) is standard convention
    ...
    switch (strtolower($phase)) {
        ...
        case 'update':
            ...
            if (!$isvalid) {
                return xarTplModule('contactform','admin','modifyconfig', $data);
            } else {
            ...
            # --------------------------------------------------------
            #
            # Updating the contactform configuration without using DD
            #
            ...
            /*
                ...
                xarModVars::set('contactform', 'bold', $bold);
            */

            # --------------------------------------------------------
            #
            # Updating the contactform configuration with DD class calls
            #
            ...
            /*
                ...
                xarResponse::redirect(xarModURL('contactform', 'admin', 'modifyconfig'));
                return true;
            */

            # --------------------------------------------------------
            #
            # Updating the contactform configuration with a DD API call
            #
            ...
            # - objectid of the contactform_module_settings object

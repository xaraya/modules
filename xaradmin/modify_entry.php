...
{
    if (!xarSecurity::check('EditReminders')) return;

    if (!xarVar::fetch('name',       'str',      $name,            'reminders_entries', xarVar::NOT_REQUIRED)) return;
    ...
    if ($data['confirm']) {
        ...
        if (!$isvalid) {
            ...
            return xarTpl::module('reminders','admin','modify_entry', $data);        
        } else {

...
function contact_admin_add_location()
{
    ...
    $data['locationlabel'] = xarVarPrepForDisplay(xarML('Add New Location'));
    $data['location_idlabel'] = xarVarPrepForDisplay(xarML('LOCATIONID'));
    $data['addlocationbutton'] = xarVarPrepForDisplay(xarML('Commit'));

    list($id,
         $locationname,
         $cid,
         $newlocation,
         $deletelocation) = xarVarCleanFromInput('id',
                                        'locationname',
                                        'cid',
                                        'newlocation',
                                        'deletelocation');

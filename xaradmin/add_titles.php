...
function contact_admin_add_titles()
{
    ...
    $data['titleslabel'] = xarVarPrepForDisplay(xarML('Add New Title'));
    $data['titles_idlabel'] = xarVarPrepForDisplay(xarML('TITLEID'));
    $data['addtitlesbutton'] = xarVarPrepForDisplay(xarML('Commit'));

    list($id,
         $titlesname,
         $cid,
         $newtitles,
         $deletetitles) = xarVarCleanFromInput('id',
                                        'titlesname',
                                        'cid',
                                        'newtitles',
                                        'deletetitles');

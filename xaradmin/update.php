...
function maxercalls_admin_update($args)
{
    ...
    if (empty($itemid)) {
        $msg = xarML('Invalid #(1) for #(2) function #(3)() in module #(4)',
                     'item id', 'admin', 'update', 'maxercalls');
    ...
    if (empty($itemtype)) {
        $msg = xarML('Invalid #(1) for #(2) function #(3)() in module #(4)',
                     'item type', 'admin', 'update', 'maxercalls');
        xarErrorSet(XAR_USER_EXCEPTION, 'BAD_PARAM',
                       new SystemException($msg));
        return $msg;
    }
    ...
    $data['menutitle'] = xarML('Modify maxercalls parameter');
...
*/
        ...
        return xarTplModule('maxercalls','admin','modify', $data);
    }

 ...
 */
function authentication_admin_createpassword()
{
    // Security Check
    ...
    if (!xarVarFetch('uid', 'isset', $uid)) {
        $msg = xarML('Invalid #(1) for #(2) function #(3)() in module #(4)','parameters', 'admin', 'createpassword', 'Authentication');
    ...
    $pass = xarModAPIFunc('authentication',
     ...
     if (!xarModGetVar('authentication', 'askpasswordemail')) {
        ...
        xarResponseRedirect(xarModURL('authentication', 'admin', 'asknotification',

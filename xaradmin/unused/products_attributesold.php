...
?>
                  ...
                  <tr>
                    <td align="right" colspan="3" class="main"><br><?php echo '<a href="' . xarModURL('commerce','admin',(FILENAME_product_ATTRIBUTES, '&value_page=' . $_GET['value_page'] . '&attribute_page=' . $attribute_page, 'NONSSL') . '">'; ?><?php echo xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_cancel.gif'),'alt' => ' cancel '); ?></a>&#160;</td>
                  </tr>
<?php
    } else {
?>
...
xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_delete.gif'),'alt' => ' delete ')                                                                                        </a>&#160;&#160;&#160;<?php echo '<a href="' . xarModURL('commerce','admin',(FILENAME_product_ATTRIBUTES, '&order_by=' . $order_by . '&page=' . $page, 'NONSSL') . '">'; ?><?php echo xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_cancel.gif'),'alt' => ' cancel '); ?></a>&#160;</td>
                  </tr>
<?php
    }
?>
...
?>
                ...
                <td align="center" class="smallText">&#160;<?php echo <input type="image" src="#xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_update.gif')#" border="0" alt=IMAGE_UPDATE>; ?>&#160;<?php echo '<a href="' . xarModURL('commerce','admin',(FILENAME_product_ATTRIBUTES, '', 'NONSSL') . '">'; ?><?php echo xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_cancel.gif'),'alt' => IMAGE_CANCEL);; ?></a>&#160;</td>
<?php
        echo '</form>' . "\n";
      } else {
?>
...
</a>&#160;&#160;<?php echo '<a href="' . xarModURL('commerce','admin',(FILENAME_product_ATTRIBUTES, 'action=delete_product_option&option_id=' . $options_values['product_options_id'], 'NONSSL') , '">'; ?><?php echo xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_delete.gif'),'alt' => IMAGE_DELETE);; ?></a>&#160;</td>
<?php
      }
?>
              </tr>
...
?>
                  ...
                  <tr>
                    <td class="main" align="right" colspan="3"><br><?php echo '<a href="' . xarModURL('commerce','admin',(FILENAME_product_ATTRIBUTES, '&value_page=' . $_GET['value_page'] . '&attribute_page=' . $attribute_page, 'NONSSL') . '">'; ?><?php echo xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_cancel.gif'),'alt' => ' cancel '); ?></a>&#160;</td>
                  </tr>
<?php
    } else {
?>
...
</a>&#160;&#160;&#160;<?php echo '<a href="' . xarModURL('commerce','admin',(FILENAME_product_ATTRIBUTES, '&option_page=' . $option_page . '&value_page=' . $_GET['value_page'] . '&attribute_page=' . $attribute_page, 'NONSSL') . '">'; ?><?php echo xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_cancel.gif'),'alt' => ' cancel '); ?></a>&#160;</td>
                  </tr>
<?php
    }
?>
...
xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_edit.gif'),'alt' => IMAGE_UPDATE)
</a>&#160;&#160;<?php echo '<a href="' . xarModURL('commerce','admin',(FILENAME_product_ATTRIBUTES, 'action=delete_option_value&value_id=' . $values_values['product_options_values_id'], 'NONSSL') , '">'; ?><?php echo xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_delete.gif'),'alt' => IMAGE_DELETE);; ?></a>&#160;</td>
<?php
      }

...
?>
              <tr>
                ...
                <td align="right" class="smallText"><?php if ( ($_GET['action'] != 'backup') && ($dir) ) echo '<a href="' . xarModURL('commerce','admin',(FILENAME_BACKUP, 'action=backup') . '">' . xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_backup.gif'),'alt' => IMAGE_BACKUP); . '</a>'; if ( ($_GET['action'] != 'restorelocal') && ($dir) ) echo '&#160;&#160;<a href="' . xarModURL('commerce','admin',(FILENAME_BACKUP, 'action=restorelocal') . '">' .
  xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_restore.gif'),'alt' => IMAGE_RESTORE);
                </a>'; ?></td>
              </tr>
<?php
...
<?php
  ...
  switch ($_GET['action']) {
    ...
    <input type="image" src="#xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_backup.gif')#" border="0" alt=IMAGE_BACKUP>
      . '&#160;<a href="' . xarModURL('commerce','admin',(FILENAME_BACKUP) . '">' . xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_cancel.gif'),'alt' => IMAGE_CANCEL); . '</a>');
      break;
    case 'restore':
  ...
  xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_restore.gif'),'alt' => IMAGE_RESTORE);
      </a>&#160;<a href="' . xarModURL('commerce','admin',(FILENAME_BACKUP, 'file=' . $buInfo->file) . '">' . xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_cancel.gif'),'alt' => IMAGE_CANCEL); . '</a>');
      break;
    case 'restorelocal':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br>' .
    <input type="image" src="#xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_restore.gif')#" border="0" alt=IMAGE_RESTORE>.
      &#160;<a href="' . xarModURL('commerce','admin',(FILENAME_BACKUP) . '">' . xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_cancel.gif'),'alt' => IMAGE_CANCEL); . '</a>');
      break;
    case 'delete':
      $heading[] = array('text' => '<b>' . $buInfo->date . '</b>');
      ...
      $contents[] = array('align' => 'center', 'text' => '<br>' . <input type="image" src="#xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_delete.gif')#" border="0" alt=IMAGE_DELETE> . ' <a href="' . xarModURL('commerce','admin',(FILENAME_BACKUP, 'file=' . $buInfo->file) . '">' . xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_cancel.gif'),'alt' => IMAGE_CANCEL); . '</a>');
      break;
    default:
      if (is_object($buInfo)) {
        $heading[] = array('text' => '<b>' . $buInfo->date . '</b>');

        $contents[] = array('align' => 'center', 'text' => '<a href="' . xarModURL('commerce','admin',(FILENAME_BACKUP, 'file=' . $buInfo->file . '&action=restore') . '">' . xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_restore.gif'),'alt' => IMAGE_RESTORE) . '</a> <a href="' . xarModURL('commerce','admin',(FILENAME_BACKUP, 'file=' . $buInfo->file . '&action=delete') . '">' . xarModAPIFunc('commerce','user','image',array('src' => xarTplGetImage('buttons/' . xarSession::getVar('language') . '/'.'button_delete.gif'),'alt' => IMAGE_DELETE); . '</a>');

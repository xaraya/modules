...
function calendar_admin_create_calendars()
{
    ...
    // message
    if (!xarVar::fetch('add_calendar', 'isset', $add_calendar)) {return;}
    if (!xarVar::fetch('calname', 'str:1:', $calname)) {return;}
    if (!xarVar::fetch('addtype', 'str:1:', $addtype)) {return;}
    if (!xarVar::fetch('location', 'str:1:', $location, '', xarVar::NOT_REQUIRED)) {return;}
    if (!xarVar::fetch('uri', 'str:1:', $uri, '', xarVar::NOT_REQUIRED)) {return;}

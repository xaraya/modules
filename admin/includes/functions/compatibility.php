<?php
/* --------------------------------------------------------------
   $Id: compatibility.php,v 1.1 2003/09/06 22:05:29 fanta2k Exp $
  ...
  if (!function_exists('checkdnsrr')) {
    function checkdnsrr($host, $type) {
      if(xarModAPIFunc('commerce','user','not_null',array('arg' => $host)) && xarModAPIFunc('commerce','user','not_null',array('arg' => $type))) {

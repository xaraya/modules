<?php
/* --------------------------------------------------------------
   $Id: database.php,v 1.1 2003/09/06 22:05:29 fanta2k Exp $
...
/*
TODO: enable xenQuery to log queries
function new xenQuery($query, $link = 'db_link') {
    global $$link, $logger;
...
*/
  // db connection for Servicedatabase
  function service_new xenQuery($query, $link_service = 'db_link_service') {
  ...
  function xtc_db_perform($table, $data, $action = 'insert', $parameters = '', $link = 'db_link') {
    ...
    return new xenQuery($query, $link);
  }

  function $q->output()($db_query) {

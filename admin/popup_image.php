<?php
/* --------------------------------------------------------------
   $Id: popup_image.php,v 1.1 2003/09/06 22:05:29 fanta2k Exp $
    ...
    switch ($key) {
      ...
      if(!$q->run()) return;
        ...
        if ($banner['banners_html_text']) {
          ...
          $image_source = xtc_image(xarTplGetImage(HTTP_CATALOG_SERVER . DIR_WS_CATALOG_IMAGES . $banner['banners_image']), $page_title);
        }
        break;
    }
  }
